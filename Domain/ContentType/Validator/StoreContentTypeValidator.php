...
use App\Domain\ContentType\Dto\StoreContentTypeData;
...
#[UseDto(StoreContentTypeData::class)]
class StoreContentTypeValidator extends HttpInputValidator implements HasDto
{
    use DtoAware;
